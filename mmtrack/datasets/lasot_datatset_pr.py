...
class LaSOTDatasetPR(BaseSOTDataset):
    ...
    def __init__(self, replace_first_frame_ann, first_frame_ann_path, *args, **kwargs):
        ...
        super(LaSOTDatasetPR, self).__init__(*args, **kwargs)
    ...
    def get_bboxes_from_video(self, video_ind):
        ...
        bboxes = bboxes[start_frame_id-1:, :]
    ...
    def get_visibility_from_video(self, video_ind):
        ...
        start_frame_id = self.data_infos[video_ind]['start_frame_id']
        end_frame_id = self.data_infos[video_ind]['end_frame_id']
        full_occlusion = full_occlusion[start_frame_id-1:]
        out_of_view = out_of_view[start_frame_id-1:]
