...
@PIPELINES.register_module()
class SeqCropPointTrack(SeqCropLikeStark):
    def __init__(self, crop_size_factor, output_size):
        super(SeqCropPointTrack, self).__init__(crop_size_factor, output_size)
...
@PIPELINES.register_module()
class SeqResizePointTrack(Resize):
