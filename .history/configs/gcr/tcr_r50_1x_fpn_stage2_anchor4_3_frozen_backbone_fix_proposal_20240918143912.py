...
# roi_feat_strides = [4, 8, 16, 16, 32, 32]
# roi_feat_strides = [4, 4, 8, 8, 16, 16]
model = dict(
...
# lr_config = dict(policy='step', step=[16, 23])
...
load_from = None
resume_from = None
# resume_from = '/home/ps/ydj/mmtracking-master/mmtracking-master-cache/tpr/tpr_r50_2x_fpn_gray_bright_stage4_anchor1/2x/epoch_9.pth'
total_epochs = 12
# total_epochs = 24
# total_epochs = 36
