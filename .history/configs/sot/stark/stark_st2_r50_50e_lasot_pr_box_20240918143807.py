...
data = dict(
    ...
    test=dict(
        type='LaSOTDatasetPR',
        replace_first_frame_ann=True,
        first_frame_ann_path='/home/ubuntu/kuiran/github/mmtracking-master/mmtracking-master-cache/tpr/tpr_r50/2x/refine/point/result.txt',
        # ann_file=data_root + 'lasot/annotations/lasot_test_infos.txt',
        ann_file=data_root + 'lasot/annotations/pr_anno/lasot_seq_similate_box_test_once.txt',
        img_prefix=data_root + 'lasot/LaSOTBenchmark')
)
