...
train_pipeline = [
    ...
    dict(
        type='SeqBboxJitter',
        center_jitter_factor=[1.75, 1.75, 4.5],
...
data = dict(
    train=dict(
        ...
        dataset_cfgs=[
            ...
            dict(
                type='LaSOTDataset',
                replace_first_frame_ann=False,
                first_frame_ann_path=None,
    ...
    # test=dict(
    #     type='LaSOTDataset',
    #     ann_file=data_root + 'lasot/annotations/lasot_test_infos_single_sequence.txt',
    #     img_prefix=data_root + 'lasot/LaSOTBenchmark')
    test=dict(
        type='LaSOTDataset',
        replace_first_frame_ann=False,
        first_frame_ann_path='/home/ubuntu/kuiran/github/mmtracking-master/exp/uti/ann/e24_point_lasot_r50.txt',
