...
def main():
    with open('/home/ubuntu/kuiran/tracking/lasot/annotations/lasot_test_infos.txt', 'r', encoding='utf-8') as f:
        data = f.readlines()
    data = data[1:]
    f.close()
    for index, ann in enumerate(data):
        data[index] = data[index].strip('\n').split(',')[1]
    prefix = '/home/ubuntu/kuiran/tracking/lasot/LaSOTBenchmark'
    output_prefix = '/home/ubuntu/kuiran/tracking/lasot/random_point_new_generation/10'
    for ann in data:
